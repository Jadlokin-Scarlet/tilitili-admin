...
export default class RecommendTalkManager extends Component {
    columnsConfig = [
        ...
        {title: '主持人', key: 'speaker', width: 70, type: 'choose', chooseMap: 'speakerList'},
    ...
    handleResourcesInit = () => ({
        ...
        speakerList: [{text: '灵梦', value: '灵梦', tag: 'red'}, {text: '早苗', value: '早苗', tag: 'green'}, {text: '灵梦&早苗', value: '灵梦&早苗', tag: 'no'}],
    })
